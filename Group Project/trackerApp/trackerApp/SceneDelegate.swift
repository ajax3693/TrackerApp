...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    private enum Constants {
        ...
        static let UserViewNavigationControllerIdentifier = "UserNavigationController"
    ...
    private func login() {
        ...
        self.window?.rootViewController = storyboard.instantiateViewController(withIdentifier: Constants.UserViewNavigationControllerIdentifier)
    }
